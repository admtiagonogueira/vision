...
<?php getTitulo('BANCO DE TALENTOS'); ?>
				...
				<div class="newdialog-boxes">
					<div class="newdialog"><a href="#" class="close"><img src="img/fechar-modal.png" /></a><br />
						<div>
							...
							<table id="vstable">
								<tr>
									<td><div style="width:128px;"></div><img src="<?php echo DIR_UPLOADS . '/img_fotos_lideres/' . $row['url_foto']; ?>" style="width:128px; height:128px; position:absolute; margin-top:5px; border:3px solid #003556;"></td>
									<td></td>
									<td colspan="3">
